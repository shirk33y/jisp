...
test "bigint constructor preserves values beyond int range"
  assert
    =
      obj "value" "32849384983498230592309502398509388908203986232306"
        ... "negative" "-9223372036854775809"
        ... "equal" true
      obj "value" (decimal (huge "32849384983498230592309502398509388908203986232306"))
...
test "bigint arithmetic stays arbitrary precision"
  assert
    =
      obj "sum" "1000000000000000000000000000003"
        ... "diff" "999999999999999999999999999997"
        ... "product" "3000000000000000000000000000000"
        ... "quotient" "333333333333333333333333333333"
      let
        left
          huge "1000000000000000000000000000000"
          right
          huge "3"
        obj "sum" (decimal (+ left right))
    ...
    =
      ...
      let
        negative
          ...
          divisor
          huge "3"
        obj "neg-div" (decimal (// negative divisor))
...
test "bigints compose inside lists objects and conditionals"
  assert
    =
      obj "first" (ok (bigint "9223372036854775808"))
        ... "has" true
        ... "branch" "large"
      let
        value
