  ...
  assert.equal
    ...
    let
      original
        (base-user)
        renamed
        rename-user original "Grace"
        public
        public-user renamed
      obj "original" (. original "name")
...
test "object keys and values preserve insertion order"
  assert.equal
    obj "keys" (list "first" "second" "third")
      ... "values" (list 1 2 3)
    let
      value
        obj "first" 1
      ...
      scores
        obj.to-map
          obj "primary" 1
            ... "secondary" 2
        without-primary
        map.del scores "primary"
      obj "has-primary" (map.has without-primary "primary")
...
test "ui shaped objects keep utility classes as boolean maps"
  assert.equal
    obj "tag" "button"
      ... "class" (obj "px-2" true "opacity-50" false "text-green" true)
      ... "attrs" (obj "id" "user-7" "title" "Ada")
      ... "children" (list (obj "tag" "text" "value" "Ada"))
    button-view
      (base-user)
