...
- Add imported-symbol go-to-definition support to the LSP and package dependency/registry
  ...
  and hover, local top-level go-to-definition, and live frontend diagnostics;
