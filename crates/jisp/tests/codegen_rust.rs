...
#[test]
fn emit_rust_detailed_emits_nested_non_enum_or_patterns() {
    let generated = jisp::emit_rust_as_detailed(
        "main.lisp",
        Syntax::Lisp,
        r#"
...
"#,
    ...
    assert!(tokens.contains("__jisp_case_subject [0usize] == 2i64"));
}

#[test]
fn emit_rust_detailed_emits_nested_object_or_patterns() {
    let generated = jisp::emit_rust_as_detailed(
        "main.lisp",
        Syntax::Lisp,
        r#"
...
"#,
    ...
    assert!(tokens.contains("__jisp_case_subject . kind == \"one\""));
    assert!(tokens.contains("__jisp_case_subject . kind == \"two\""));
}
