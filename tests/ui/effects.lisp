; Fixture-only capability declarations and deliveries use the deterministic
; FakeHost. They execute no browser or native I/O, but exercise the portable
; completion action that a real host would feed back into update.
(type Action
  (Save)
  (Saved int)
  (SaveFailed obj)
