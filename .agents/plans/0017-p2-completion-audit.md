...
| Expression-level native source mapping | Current map locates generated structs/enums/functions only. | Stable generated expression ranges, Cargo primary/secondary label remapping, macro-origin mapping, and diagnostic fixture tests. |
