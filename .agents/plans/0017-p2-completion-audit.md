...
| Template macros with local binding hygiene and origin diagnostics | `jisp-expand` tests, facade expansion tests, and `.agents/plans/0010-user-macros.md`; portable module-level error fixture coverage now asserts the reserved `macro-import` diagnostic. |
