...
(test "bigint arithmetic stays arbitrary precision"
  (assert (=
    ...
    (let (left (huge "1000000000000000000000000000000")
          right (huge "3"))
      (obj
...
(test "bigint comparisons and math helpers use bigint ordering"
  (assert (=
    ...
    (let (small (huge "-50")
          large (huge "100000000000000000000"))
      (obj
        "less" (< small large)
        "greater" (> large small)
...
(test "bigints compose inside lists objects and conditionals"
  (assert (=
    (obj
      ...
      "has" true
      "branch" "large")
    (let (value (huge "9223372036854775808")
          values (list value (huge "9223372036854775809")))
      (obj
