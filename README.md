...
| `lsp` | Start a stdio Language Server Protocol endpoint with initialization, core-form completion and hover, top-level go-to-definition (including qualified imports), and live frontend diagnostics for opened or changed documents. |
