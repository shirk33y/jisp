...
| Package registry tooling | Local path dependencies and lockfiles are supported, but external registry semantics are not designed. | Registry manifest schema, source/index decision, checksum policy, and offline tests. |
