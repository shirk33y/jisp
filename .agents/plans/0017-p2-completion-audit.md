...
| Macro-origin remapping for native diagnostics | Primary and secondary Cargo spans now select stable expression/item ranges. | Attach macro-origin chains in diagnostic fixtures. |
